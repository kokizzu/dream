...
[streams](https://camlworks.github.io/dream/#streaming-uploads) uploaded files
...
[`Dream.csrf_tag`](https://camlworks.github.io/dream/#val-csrf_tag) inside the
...
code, see
[`Dream.verify_csrf_token`](https://camlworks.github.io/dream/#val-verify_csrf_token).
