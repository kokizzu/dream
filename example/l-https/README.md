...
[`Dream.run`](https://camlworks.github.io/dream/#val-run):
...
[localhost certificate](https://github.com/camlworks/dream/tree/master/src/certificate),
...
[`Dream.run`](https://camlworks.github.io/dream/#val-run) with
...
[`Dream.version`](https://camlworks.github.io/dream/#val-version) on any given
request.
