...
[`Dream.run`](https://camlworks.github.io/dream/#val-run). The easiest way to
get an `error_handler` is to call
[`Dream.error_template`](https://camlworks.github.io/dream/#val-error_template):
...
- [**`a-log`**](../a-log#folders-and-files) shows how to write messages to
  Dream's [log](https://camlworks.github.io/dream/#logging).
- [**`b-session`**](../b-session#folders-and-files) adds [session
  management](https://camlworks.github.io/dream/#sessions) for associating state
  with clients.
